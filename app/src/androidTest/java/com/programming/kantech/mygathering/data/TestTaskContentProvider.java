...
package com.programming.kantech.mygathering.data;
...
import com.programming.kantech.mygathering.provider.DBHelper;
import com.programming.kantech.mygathering.provider.Provider_MyGathering;
...
public class TestTaskContentProvider {
    ...
    public void setUp() {
        ...
        database.delete(Contract_MyGathering.TopicEntry.TABLE_NAME, null, null);
    }
    ...
    public void testProviderRegistry() {
        ...
        String taskProviderClassName = Provider_MyGathering.class.getName();
        ...
        try {
            ...
            String incorrectAuthority =
                    "Error: Provider_MyGathering registered with authority: " + actualAuthority +
            ...
            String providerNotRegisteredAtAll =
                    "Error: Provider_MyGathering not registered at " + mContext.getPackageName();
            /*
    ...
    private static final Uri TEST_TASKS = Contract_MyGathering.TopicEntry.CONTENT_URI;
    ...
    public void testUriMatcher() {
        ...
        UriMatcher testMatcher = Provider_MyGathering.buildUriMatcher();

        /* Test that the code returned from our matcher matches the expected TASKS int */
        String tasksUriDoesNotMatch = "Error: The TOPICS URI was matched incorrectly.";
        int actualTasksMatchCode = testMatcher.match(TEST_TASKS);
        int expectedTasksMatchCode = Provider_MyGathering.TOPICS_ALL;
        ...
        String taskWithIdDoesNotMatch =
                "Error: The TOPIC_WITH_ID URI was matched incorrectly.";
        int actualTaskWithIdCode = testMatcher.match(TEST_TASK_WITH_ID);
        int expectedTaskWithIdCode = Provider_MyGathering.TOPICS_ID;
    ...
    public void testInsert() {
        ...
        values.put(Contract_MyGathering.TopicEntry.COLUMN_TOPIC_NAME, "test name");
        ...
        contentResolver.registerContentObserver(
                ...
                Contract_MyGathering.TopicEntry.CONTENT_URI,
        ...
        Uri uri = contentResolver.insert(Contract_MyGathering.TopicEntry.CONTENT_URI, values);


        //Uri expectedUri = ContentUris.withAppendedId(Contract_MyGathering.TopicEntry.CONTENT_URI, 1);

        long id = 1;

        Uri expectedUri = Contract_MyGathering.TopicEntry.buildTopicUri(id);
    ...
    public void testQuery() {
        ...
        testTaskValues.put(Contract_MyGathering.TopicEntry.COLUMN_TOPIC_NAME, "Test name");
        //testTaskValues.put(Contract_MyGathering.TopicEntry.COLUMN_PRIORITY, 1);

        /* Insert ContentValues into database and get a row ID back */
        long taskRowId = database.insert(
                /* Table to insert values into */
                Contract_MyGathering.TopicEntry.TABLE_NAME,
                null,
    ...
    public void testDelete() {
        ...
        Uri uriToDelete = Contract_MyGathering.TopicEntry.CONTENT_URI.buildUpon().appendPath("1").build();

...
public class JobService_SearchForNewGatherings extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        Log.i(Constants.TAG, "onStartJob() called");
        ...
        mBackgroundTask = new AsyncTask() {
            ...
            protected Object doInBackground(Object[] params) {
                ...
                // when finished.
                Log.i(Constants.TAG, "doInBackground called");
                Context context = JobService_SearchForNewGatherings.this;
                Tasks_Gatherings.executeTask(context, Tasks_Gatherings.ACTION_SEARCH_FOR_NEW_GATHERINGS);
                return null;
            }

            @Override
            protected void onPostExecute(Object o) {
                Log.i(Constants.TAG, "onPostExecute called");
